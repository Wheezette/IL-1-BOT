  ...
  */
  ...
  loadCommand(commandPath, commandName) {
    try {
      ...
      this.logger.log(`Wczytywanie polecenia: ${props.help.name}. 👌`, "log");
...
client.on("ready", e => {
  setInterval (function (){
    ...
    if (statusrand === 2) {
      client.user.setActivity(`${client.users.size} użytkowników`, {type: 'WATCHING'});  
      console.log(statusrand);
    }
    if (statusrand === 3) {
      client.user.setActivity(`${client.guilds.size} serwerów`, {type: 'WATCHING'});  
      console.log(statusrand);
    }
    if (statusrand === 4) {
      client.user.setActivity(`${client.channels.size} kanałów`, {type: 'WATCHING'});  
      console.log(statusrand);
    }
    if (statusrand === 5) {
